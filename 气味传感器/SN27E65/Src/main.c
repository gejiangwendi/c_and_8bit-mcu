...
void __interrupt [0x0B] isr_t0 (void)	//4ms
{
	FT0IRQ	=	0;
	T0C		=	5;
	f_4ms	=	1;
...
void __interrupt [0x0C] isr_tc0 (void)	//0.100ms
{
	FTC0IRQ	=	0;
	TC0C	=	156;
	num_01ms++;
...
void __interrupt [0x0E] isr_tc2 (void)	//0.125ms
{
	FTC2IRQ	=	0;
	TC2C	=	131;    //0.125ms
	if(BUZZER_ON)
